...
g1 = Group.create(name: "Sports",user_id: 1)
g2 = Group.create(name: "Sports",user_id: 2)
g3 = Group.create(name: "Alma Mater",user_id:2)
g4 = Group.create(name: "Alma Mater",user_id:3)
g5 = Group.create(name: "Cooking",user_id:4)
